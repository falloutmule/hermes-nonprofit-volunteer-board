export const SMS_MESSAGES = {
  joined: "Hermes Non-Profit: You're enrolled in volunteer SMS coordination. Msg frequency varies, typically 1-8 msgs/event. Msg & data rates may apply. Reply HELP for help or STOP to opt out.",
  help: "Hermes Non-Profit Volunteer SMS: Help at Falloutmule@gmail.com. Msg & data rates may apply. Reply STOP to opt out.",
